...
## gSpanの実装について
最も複雑なgSpanの実装について, 簡単な図を残しておく. 

<img src="./picture/gspan.png" alt="gspan">

- gSapnで得られる部分グラフの頻度 (個数)は, オーバーラップを許した頻度である

<img src="./picture/overlap.png" width=500>

- オーバーラップあり頻度は部分グラフパターンの増大に対して, 増えることがありうる (赤のパターンから赤緑のパターンへの拡張は, 頻度が1から2へ増える)

<img src="./picture/frequency.png" width=500>

※系列データでは, 部分系列パターンの長さが増えるほど頻度は単調に減少するため, グラフでも成り立つのではないかと勘違いしやすい. 

なお, グラフの場合でも, オーバーラップなし頻度にすれば単調性は満たされるが, その計算はNP完全である. 
